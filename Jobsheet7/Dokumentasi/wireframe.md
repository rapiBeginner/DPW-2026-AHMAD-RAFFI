...
- **Member**: Bisa memesan (booking) jika ingin meminjam satu buku tertentu, sehingga tidak kehabisan stok
...
```
## User Flow — Pemesanan Buku

```
[Member Login] -> [Dashboard] -> [Menu "Pesan Buku"] 
        -> [Pilih Buku (stok>0)] -> [Pilih tanggal Ambil(tanggal max hari ini+2)]
        -> [Simpam]-> [Data pemesanan bertambah 1] -> [Kembali ke Dashboard]
```
...
## Wireframe: Form Pemesanan

```
+--------------------------------------+
|  Form Peminjaman Buku                |
|--------------------------------------|
|  Buku     :[ dropdown pilih anggota ]|
|  Tanggal Pesan :[ input tanggal ]    |
|                                      |
|                                      |
|          [  Simpan Pemesanan  ]      |
+--------------------------------------+
